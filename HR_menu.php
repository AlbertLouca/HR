		...
		<div class="topnav " >
			...
			<?php
				if(!empty($_SESSION['ID'])) 
				{
					...
					echo "<a class='bg-dark' href='HR_opor.php' >".$_SESSION['Fname']."</a>";  //1
					echo "<a class='bg-dark' href='HR_FQA2.php' > <i class='far fa-question-circle' ></i> FAQ</a>";  //2 
					
					
					
                    echo "<a class='bg-dark' href='HR_hrletter.php' ><i class='fas fa-mail-bulk' style='font-size:22px'></i>  Review Letters</a>"; //3 
                    echo "<a class='bg-dark' href='HR_registration.php' ><i class='fas fa-mail-bulk' style='font-size:22px'></i>  Review registration</a>"; //3 
                    
					echo"<a class='bg-dark' href='HR_home.php'><i class='fas fa-home' ></i> Home</a>";  
					
				}
				else
				{
					echo '<a   id="log"  href="HR_home.php"><img src="WhirlpoolCorp-2017Logo_1C_W.png" 
					style="width:200px; height:60px" title="HR" alt="HR"></a>';
